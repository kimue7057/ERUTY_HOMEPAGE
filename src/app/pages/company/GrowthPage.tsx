...
const UI = {
  ko: {
    ...
    metricsNote: "* 00+ 표시 항목은 현재 정보 업데이트 예정입니다. 검증된 수치로 순차 교체됩니다.",
  ...
  en: {
    ...
    metricsNote: "* Items marked 00+ are pending update. Will be replaced with verified figures sequentially.",
    timelineLabel: "Growth Timeline",
...
const metricsData = {
  ko: [
    { label: "설립연도", value: "2023", unit: "", note: "회사 설립" },
    { label: "누적 프로젝트", value: "00", unit: "+", note: "정보 업데이트 예정" },
    { label: "글로벌 파트너", value: "00", unit: "+", note: "정보 업데이트 예정" },
    { label: "협력 크리에이터", value: "00", unit: "+", note: "정보 업데이트 예정" },
    { label: "특허·상표", value: "00", unit: "+", note: "정보 업데이트 예정" },
    { label: "연구개발 과제", value: "00", unit: "+", note: "정보 업데이트 예정" },
  ],
  en: [
    { label: "Founded", value: "2023", unit: "", note: "Company Established" },
    { label: "Total Projects", value: "00", unit: "+", note: "Pending Update" },
    { label: "Global Partners", value: "00", unit: "+", note: "Pending Update" },
    { label: "Creator Partners", value: "00", unit: "+", note: "Pending Update" },
    { label: "Patents & Trademarks", value: "00", unit: "+", note: "Pending Update" },
    { label: "R&D Projects", value: "00", unit: "+", note: "Pending Update" },
  ],
};
...
const milestonesData = {
  ko: [
    ...
    { id: "m9", year: "2023", month: "01", category: "Company", headline: "이루티 법인 설립", desc: "글로벌 콘텐츠 비즈니스와 AI 기술을 결합한 사업 목적으로 법인을 설립했습니다." },
  ],
  en: [
    ...
    { id: "m9", year: "2023", month: "01", category: "Company", headline: "ERUTY Corporation Founded", desc: "Established as a corporation with the mission of combining global content business and AI technology." },
  ],
};
...
const credentials: Credential[] = [
  ...
  {
    id: "ip1", group: "ip",
    name: "등록 특허 (업데이트 예정)", nameEn: "Registered Patent (Pending)",
    issuer: "특허청", issuerEn: "Korean Intellectual Property Office",
    date: "업데이트 예정", dateEn: "Pending Update",
    status: "placeholder",
    refNumber: "특허 번호 업데이트 예정",
    summary: "AI 또는 콘텐츠 기술 분야 특허 정보는 등록 후 업데이트될 예정입니다.",
    summaryEn: "Patent information in the AI or content technology domain will be updated after registration.",
    docAvailable: false,
  },
  {
    id: "ip2", group: "ip",
    name: "출원 특허 (업데이트 예정)", nameEn: "Patent Application (Pending)",
    issuer: "특허청", issuerEn: "Korean Intellectual Property Office",
    date: "업데이트 예정", dateEn: "Pending Update",
    status: "pending",
    refNumber: "출원 번호 업데이트 예정",
    summary: "출원 진행중인 특허 정보는 심사 결과 후 업데이트될 예정입니다.",
    summaryEn: "Pending patent application information will be updated after examination results.",
    docAvailable: false,
  },
  {
    id: "ip3", group: "ip",
    name: "상표 (업데이트 예정)", nameEn: "Trademark (Pending)",
    issuer: "특허청", issuerEn: "Korean Intellectual Property Office",
    date: "업데이트 예정", dateEn: "Pending Update",
    status: "placeholder",
    refNumber: "상표 번호 업데이트 예정",
    summary: "이루티 브랜드 상표 정보는 등록 후 업데이트될 예정입니다.",
    summaryEn: "ERUTY brand trademark information will be updated after registration.",
    docAvailable: false,
  },
