...
export const T = {
  ko: {
    ...
    introDescription: "히트픽은 글로벌 시장의 신호를 읽고, 크리에이터와 함께 수요를\n만들며 판매·수출·운영까지 직접 실행하여 브랜드의 성장을 완성합니다.",
    introCta: "프로젝트 시작하기",
  ...
  en: {
    ...
    introDescription: "HITPICK reads global market signals and builds demand with creators,\nthen directly executes sales, export, and operations to complete brand growth.",
